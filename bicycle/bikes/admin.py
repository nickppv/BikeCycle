...
class New_BikeAdmin(admin.ModelAdmin):
    ...
    # не позволяет редактировать это поле даже при добавлении записи
    # через админку
    readonly_fields = []
...
# количества колес. Создаем функцию и регистрируем ее здесь же - выше.
    ...
    # добавляет панель с кнопками удалить/сохранить на верх страницы в админке
    save_on_top = True
